package com.example.android_appSim;
...
public class AppSimMainViewActivity extends Activity implements Runnable {
		...
		changeCategoryBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if(isUserApp){
					...
					//设置标志位
					isUserApp = false;
					Toast.makeText(AppSimMainViewActivity.this, "用户自己的程序", 2000).show();
				}else{
					...
					//设置标志位
					isUserApp = true;
					Toast.makeText(AppSimMainViewActivity.this, "所有的程序", 2000).show();
				}
				gridView.setAdapter(new GridViewAdapter(showPackageInfos, AppSimMainViewActivity.this));
				listView.setAdapter(new ListViewAdapter(showPackageInfos, AppSimMainViewActivity.this));
			}
		});
		...
		changeViewBtn.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if(isListView == true){
					...
					//设置标志位
					isListView = false;
					Toast.makeText(AppSimMainViewActivity.this, "当前是列表视图", 2000).show();
					...
					//设置标志位
					isListView = true;
					Toast.makeText(AppSimMainViewActivity.this, "当前是网格视图", 2000).show();
	...
	OnItemClickListener listener = new OnItemClickListener() {
		...
		public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
			...
			//创建一个Dialog用来进行选择
			AlertDialog.Builder builder = new AlertDialog.Builder(AppSimMainViewActivity.this);
			builder.setTitle("选项");
			//接收一个资源的ID
			builder.setItems(R.array.choiceSim,new DialogInterface.OnClickListener() {
				@Override
				public void onClick(DialogInterface dialog, int which) {
					...
					case 0:
						...
						if(activityInfo == null) {
							Toast.makeText(AppSimMainViewActivity.this, "没有任何activity", Toast.LENGTH_SHORT).show();
							return;
						}
					...
					case 1:
						//显示apk详细信息
						Log.d("tcp",packageInfo.packageName);
						Log.d("tcp",Uri.parse("package:" + packageInfo.packageName).toString());						
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.action_chat:
			Intent intent=new Intent();
			intent.setClass(AppSimMainViewActivity.this,WiFiServiceDiscoveryActivity.class);
			AppSimMainViewActivity.this.startActivity(intent);	
			return true;
		case R.id.action_photo:	
			Intent intentset=new Intent(AppSimMainViewActivity.this,TestPicSimActivity.class);
			AppSimMainViewActivity.this.startActivity(intentset);
			return true;

		case R.id.action_app:	
			Intent intentapp=new Intent(AppSimMainViewActivity.this,AppSimMainViewActivity.class);
			AppSimMainViewActivity.this.startActivity(intentapp);
			return true;

		case R.id.action_file:	
			Intent intentbro=new Intent(AppSimMainViewActivity.this,FileSimMainActivity.class);
			AppSimMainViewActivity.this.startActivity(intentbro);
			return true;
